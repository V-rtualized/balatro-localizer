            ...
            >
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange(e.target.value, category, key, 'name')
                  }
                />
              </label>
              <label>
                ...
                {data.descriptions[category][key].text.map((val, index) => (
                  <input
                    ...
                    value={val}
                    onChange={(e) =>
                      handleChange(e.target.value, category, key, 'text', index)
                    }
                  />
                ))}
                <button
                  onClick={() => {
                    handleChange(
                      ...
                      key,
                      'text',
                      data.descriptions[category][key].text.length - 1,
                    )
                  }}
                  style={{
                    transform: 'scale(0.8)',
                ...
                <button
                  onClick={() => {
                    handleChange(
                      ...
                      key,
                      'text',
                      data.descriptions[category][key].text.length,
                    )
                  }}
                  style={{
                    transform: 'scale(0.8)',
